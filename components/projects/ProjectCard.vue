        ...
        <div class="flex-1 flex flex-col justify-between">
          <div>
            ...
            <nuxt-link class="group" :to="localePath(`/projects/${project.slug}`)">
              <h3 class="mt-0.5 group-hover:text-yellow-400 text-md leading-7 font-semibold text-gray-200">
                {{ project.title }}
              </h3>
          ...
          <div class="flex mt-2 space-x-2 flex-row">
            <a target="_blank" rel="noreferrer" :href="project.website" class="hover:text-yellow-400 text-gray-600">
            ...
            <a target="_blank" rel="noreferrer" :href="project.github" class="hover:text-yellow-400 text-gray-600">
